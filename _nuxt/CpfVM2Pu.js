import{aj as m,ak as l,bO as n,bi as c,d as s,i as p,a1 as d,g,G as t}from"./Cu2xuHFt.js";import{s as h}from"./DMHUsMio.js";var u=m`
    .p-imagecompare {
        position: relative;
        overflow: hidden;
        width: 100%;
...
`,b={root:"p-imagecompare",slider:"p-imagecompare-slider"},f=l.extend({name:"imagecompare",style:u,classes:b}),v={name:"BaseImageCompare",extends:h,props:{tabindex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:f,provide:function(){return{$pcImageCompare:this,$parentInstance:this}}},w={name:"ImageCompare",extends:v,methods:{onSlide:function(a){var o=a.target.value,i=a.target.previousElementSibling;n(i,c("imagecompare.scope.x").name,"".concat(o,"%"))}}},y=["aria-labelledby","aria-label"];function k(e,a,o,i,z,r){return p(),s("div",t({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[d(e.$slots,"left"),d(e.$slots,"right"),g("input",t({type:"range",min:"0",max:"100",value:"50",onInput:a[0]||(a[0]=function(){return r.onSlide&&r.onSlide.apply(r,arguments)}),class:e.cx("slider")},e.ptm("slider")),null,16)],16,y)}w.render=k;export{w as default};
